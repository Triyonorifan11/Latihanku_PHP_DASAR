    ...
    <div class="container">
        <div class="row py-3">
            ...
            <div class="my-4 col-md-12 d-md-flex ">
                ...
                <a href="print.php" class="btn btn-secondary ms-2 me-auto" target="_blank">Print Data</a>
                <form action="" method="POST" class="d-flex col-lg-3 col-md-6 col-sm-12">
                    ...
                    <input class="form-control me-2" id="keysearch" type="text" name="keysearch" placeholder="Cari menu.." size="10" autofocus aria-label="Search" autocomplete="off">
                    <button class="btn btn-outline-success" id="button-search" type="submit" name="search">Search</button>
                </form>
            </div>
