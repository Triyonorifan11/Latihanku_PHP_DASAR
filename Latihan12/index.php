...
$jumlahData = count(query("SELECT * FROM tb_menuresto"));
$jumlahHalaman = ceil($jumlahData / $jumlahdataPerhalaman);

$pageactive = (isset($_GET["page"])) ? $_GET["page"] : 1;

$firstpage = ($jumlahdataPerhalaman * $pageactive) - $jumlahdataPerhalaman;


$menuresto = query("SELECT * FROM tb_menuresto LIMIT $firstpage, $jumlahdataPerhalaman");
...
<body>
    <div class="container">
        <div class="row py-3">
            ...
            <!-- navigasi pagination -->
            <div class="btn-group btn-group-sm col-2 mb-3" role="group" aria-label="Basic radio toggle button group">
                <?php if ($pageactive > 1) : ?>
                    <a href="?page=<?= $pageactive - 1; ?>" class="btn btn-outline-secondary me-2">&laquo;</a>
                <?php endif; ?>
                <?php for ($i = 1; $i <= $jumlahHalaman; $i++) : ?>
                    ...
                    <?php endif; ?>
                <?php endfor; ?>
                <?php if ($pageactive < $jumlahHalaman) : ?>
                    <a href="?page=<?= $pageactive + 1; ?>" class="btn btn-outline-secondary ms-2">&raquo;</a>
                <?php endif; ?>
